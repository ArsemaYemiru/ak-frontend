            ...
            <section className="hero-section">
                ...
                <div className={`hero-content ${isVisible ? 'visible' : ''}`}>
                    ...
                    <h1 className="hero-title">
                        <span className="title-line">Stunning</span>
                        <span className="title-line delay-1">Necklaces</span>
                    </h1>
                    <p className="hero-subtitle">
                        Adorn yourself with our handcrafted necklaces, where Ethiopian heritage meets timeless sophistication
                    </p>
            ...
            <section className="products-section">
                <div className="container">
                    <div className="section-header">
                        <div>
                            <h2 className="section-title">Our Necklace Collection</h2>
