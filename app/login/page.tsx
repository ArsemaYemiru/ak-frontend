...
import { Mail, Lock, ArrowRight, Loader2, Sparkles, ChevronRight } from 'lucide-react';
            ...
            <section className="hero-section">
                ...
                <div className={`hero-content ${isVisible ? 'visible' : ''}`}>
                    ...
                    <h1 className="hero-title">
                        ...
                        <span className="title-line delay-1">Back</span>
                    </h1>
                    <p className="hero-subtitle">
                        Sign in to access your exclusive collection and manage your orders
                    </p>
